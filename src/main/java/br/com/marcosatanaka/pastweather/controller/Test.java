    ...
    public static void main(String[] args) {
        ...
        if (daily.days() < 0) {
            ...
            WeatherData weatherData = WeatherData.builder()
                    ...
                    .withAparentTemperature(null)
                    .withAparentTemperatureMin(null)
                    .withAparentTemperatureMinTime(null)
                    .withAparentTemperatureMax(null)
                    .withAparentTemperatureMaxTime(null)
